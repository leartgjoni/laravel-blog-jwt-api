            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {{Form::model($post,['url'=>route('posts.update',["id"=>$post->id]),'method' => 'PATCH'])}}
                        <div class="form-group">
                            {{ Form::label('title', trans('article.title'), ['class'=>'form-label']) }}
                            {{ Form::text('title', null, array('class'=>'form-control', 'placeholder'=>trans('article.title'), 'maxlength'=>'255', 'id'=>'title')) }}
                        </div>
                        <div class="form-group">
